 ...
 * Use the [UsFragment.newInstance] factory method to
...
class UsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyclerView = view.findViewById(R.id.usRecyclerView)
        (activity as AppCompatActivity).supportActionBar?.title = "US News"
        ...
        lifecycleScope.launch {
            ...
            val response = newsApiService.getTopHeadlines("us", ApiKey.KEY, formattedDateFrom)
